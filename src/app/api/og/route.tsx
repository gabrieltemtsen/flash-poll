...
export const runtime = "edge"; // Use Edge runtime for fast image generation
      ...
      (
        ...
        >
          ...
          <p style={{ fontSize: 24, textAlign: "center", color: "#4b5563" }}>
            Font loading failed. Please try again.
          </p>
        </div>
      ),
    ...
    (
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: 18, color: "#6b46c1", fontWeight: 700 }}>
